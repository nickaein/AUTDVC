...
public:
	...
	template <class T1>
	VectorEx<T1> histogramRegion(int nBins,double left,double top,double right,double bottom) const;
...
template <class T>
template <class T1>
VectorEx<T1> Image<T>::histogramRegion(int nBins,double left,double top,double right,double bottom) const
{
	VectorEx<T1> histogram(nBins);
